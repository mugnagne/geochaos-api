...
export const TRANSLATIONS = {
  fr: {
    ...
    username: "Pseudo (Leaderboard)",
    username_placeholder: "Ton pseudo...",
    bonus_unusable: "Inutilisable (Dernière manche)",
    bonus_zombie_desc: "Cliquez sur une catégorie utilisée",
    bonus_stats_revealed: "Stats révélées",
    bonus_points_x2: "Points x2 pour cette manche !",
    bonus_use: "Utiliser le bonus",
    round_skipped: "Manche Passée",
    bonus_double: "Bonus Quitte ou Double",
    x2_next_round: "x2 Prochain Tour",
    anonymous: "Anonyme",
    collection_flip: "Cliquez sur la carte pour la retourner",
    collection_edition: "ÉDITION",
    collection_stats: "Statistiques de la carte",
    bonus_wheel_title: "Bonus de Partie",
    bonus_wheel_spin: "LANCER LA ROUE",
    bonus_RELOCATION_name: "Déménagement",
    bonus_RELOCATION_desc: "Relance aléatoirement la roue des pays une seule fois.",
    bonus_REROLL_name: "Reroll",
    bonus_REROLL_desc: "Change une des catégories non jouées pour une autre aléatoirement.",
    bonus_ZOMBIE_name: "Zombie",
    bonus_ZOMBIE_desc: "Permet de resélectionner une catégorie déjà utilisée auparavant.",
    bonus_CLAIRVOYANT_name: "Voyante",
    bonus_CLAIRVOYANT_desc: "Affiche les stats du pays actuel dans toutes les catégories.",
    bonus_DOUBLE_OR_NOTHING_name: "Quitte ou Double",
    bonus_DOUBLE_OR_NOTHING_desc: "Passe la manche actuelle, mais la prochaine compte double.",
    bonus_FORESHADOWING_name: "Foreshadowing",
    bonus_FORESHADOWING_desc: "Permet de connaître le prochain pays sélectionné à l'avance.",
  },
  en: {
    title_geo: "GEO",
    title_chaos: "CHAOS",
    ...
    username: "Username (Leaderboard)",
    username_placeholder: "Your username...",
    bonus_unusable: "Unusable (Last round)",
    bonus_zombie_desc: "Click on a used category",
    bonus_stats_revealed: "Stats revealed",
    bonus_points_x2: "Points x2 for this round!",
    bonus_use: "Use bonus",
    round_skipped: "Round Skipped",
    bonus_double: "Double or Nothing Bonus",
    x2_next_round: "x2 Next Round",
    anonymous: "Anonymous",
    collection_flip: "Click the card to flip it",
    collection_edition: "EDITION",
    collection_stats: "Card Statistics",
    bonus_wheel_title: "Game Bonus",
    bonus_wheel_spin: "SPIN THE WHEEL",
    bonus_RELOCATION_name: "Relocation",
    bonus_RELOCATION_desc: "Randomly spins the country wheel one more time.",
    bonus_REROLL_name: "Reroll",
    bonus_REROLL_desc: "Changes an unplayed category for a random new one.",
    bonus_ZOMBIE_name: "Zombie",
    bonus_ZOMBIE_desc: "Allows you to select an already played category.",
    bonus_CLAIRVOYANT_name: "Clairvoyant",
    bonus_CLAIRVOYANT_desc: "Displays the current country's stats in all categories.",
    bonus_DOUBLE_OR_NOTHING_name: "Double or Nothing",
    bonus_DOUBLE_OR_NOTHING_desc: "Skips the current round, but the next one counts double.",
    bonus_FORESHADOWING_name: "Foreshadowing",
    bonus_FORESHADOWING_desc: "Reveals the next selected country in advance.",
  }
};
